        ...
        <div class="card">
            <div class="card-header" style="">
                <nav class="nav  justify-content-between">
                    <a class="navbar-brand">@lang('main.messagesstatus.create')</a>
            ...
            <div class="card-body">
                ...
                <form action="{{route('messagesstatus.store')}}" method="post" id="hezecomform" name="hezecomform" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        
	                <div class="form-group">
                        <label class="control-label" for="message_id">@lang('main.messagesstatus.field.message_id')</label>
	                     <input id="message_id" name="message_id" class="form-control styler" type="text" maxlength="11"  value="" />
	                </div>

	                <div class="form-group">
                        <label class="control-label" for="user_id">@lang('main.messagesstatus.field.user_id')</label>
	                     <input id="user_id" name="user_id" class="form-control styler" type="text" maxlength="11"  value="" />
	                </div>

	                <div class="form-group">
                        <label class="control-label" for="sent_status">@lang('main.messagesstatus.field.sent_status')</label>
	                     <input id="sent_status" name="sent_status" class="form-control styler" type="text" maxlength="4"  value="" />
	                </div>

	                <div class="form-group">
                        <label class="control-label" for="sent_at">@lang('main.messagesstatus.field.sent_at')</label>
	                     <input id="sent_at" name="sent_at" type="text" class="datepicker form-control styler" value="" />
	                </div>
