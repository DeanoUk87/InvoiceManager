...
Route::prefix('admin/customers')->group(function () {
    ...
    Route::get('login/{id}', 'Admin\CustomersController@LoginAccess')->name('customers.login');
    Route::post('store/login', 'Admin\CustomersController@LoginPro')->name('customers.login.store');
    ...
    Route::post('auto-search', 'Admin\CustomersController@customerAuto')->name('customers.auto');
    Route::get('truncate', 'Admin\CustomersController@truncateTable')->name('customers.truncate');
});
