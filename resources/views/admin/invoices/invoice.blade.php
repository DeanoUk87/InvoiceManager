...
@section('content')
                ...
                <div class="card-header">
                    <nav class="nav  justify-content-between">
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{route('invoices.pdfdetails',['account'=>$customer_account,'invno'=>$invoice_number,'date'=>$invoice_date])}}" class="btn btn-success btn-sm" ><i class="fa fa-file-pdf"></i> @lang('app.pdf')</a>
                            <a href="{{route('invoices.exceldetails',['account'=>$customer_account,'invno'=>$invoice_number,'date'=>$invoice_date])}}" class="btn btn-danger btn-sm" ><i class="fa fa-file-excel-o"></i> Excel</a>
                            <a href="{{route('invoices.pdfdetails',['account'=>$customer_account,'invno'=>$invoice_number,'date'=>$invoice_date,'print'=>1])}}" class="btn btn-warning btn-sm" target="_blank"><i class="fa fa-print"></i> Print</a>
                                    ...
                                    <tr>
                                        ...
                                        <td width="36%" align="right" >
                                            <table class="table table-bordered" width="100%" border="0" cellspacing="0" >
                                                ...
                                                <tr>
                                                    <td align="right" width="70%"><strong>PERCENTAGE RESOURCING SURCHARGE  {{$prof->percentage_resourcing_surcharge}}%:</strong></td>
                                                ...
                                                <tr style="border-top:#CCC 1px solid; border-bottom:#CCC 1px solid; padding:10px;">
                                                    <td align="right"><strong style="color:#00773b;">TOTAL:</strong></td>
    ...
    <!-- Modal -->
    @if(Auth::user()->hasAnyRole(['admin','admin2']))
        <form action="{{route('invoices.sendmail')}}" method="post" id="" name="hezecomform">
            {{ csrf_field() }}
            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel">Email Invoice to {{strtoupper($prof->customer_name)}}</h4>
                        </div>
