...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head>
    <meta name="viewport" content="width=device-width; initial-scale=1.0; maximum-scale=1.0;"><title>{{$title}}</title><style>
                            ...
                            <tr>
                                <td align="center" valign="middle">
                                    <table width="165" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="center" valign="middle">
                                                <a href="#"><img style="width: 200px;" alt="" src="{{asset('public/templates/admin/images/logo.png')}}"></a>
                                            </td>
                                        </tr>
                                        <tr>
            ...
            <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td align="center" valign="top">
                        <table width="600" align="center" class="main" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td align="center" valign="middle" style="border-radius: 8px 8px 0px 0px; background-color: rgb(193, 24, 107); -moz-border-radius: 8px 8px 0px 0px;" bgcolor="#18c197" data-bgcolor="theme-bg">
                                    <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td height="25" align="center" valign="middle" style="line-height:25px; font-size:25px;">&nbsp;

                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center" valign="middle" style="font-family:'Open Sans', Verdana, Arial; font-size:30px; color:#FFF; font-weight:normal;">
                                                <multiline>
                                                    activation
                                                </multiline>
                                            </td>
                            ...
                            <tr>
                                <td align="center" valign="middle" bgcolor="#ffffff">
                                    <table width="350" class="two-left-inner" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td align="center" valign="middle">
                                                <table width="155" align="center" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td height="48" align="center" valign="middle" style='background: rgb(193, 24, 107); border-radius: 25px; color: rgb(255, 255, 255); text-transform: uppercase; line-height: 28px; font-family: "Open Sans", Verdana, Arial; font-size: 15px; font-weight: normal; -moz-border-radius: 25px;' data-bgcolor="theme-bg">
                                                            <multiline>
                                                                <a style="text-decoration:none; color:#FFF;" href="{{route('login')}}" data-color="link-white">access here</a>
                                                            </multiline>
                                                        </td>
                                                    </tr>
                                                </table>
                                        ...
                                        <tr>
                                            <td align="center" valign="middle">
                                                <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr>
                                                        <td align="center" valign="top">
                                                            <table width="355" align="center" class="full" border="0" cellspacing="0" cellpadding="0">
