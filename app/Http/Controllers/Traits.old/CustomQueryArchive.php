...
trait  CustomQueryArchive
{
    ...
    public function InsertInvoice($customer_account, $invoice_number, $invoice_date, $due_date, $date_created, $terms, $sales_id, $po_number)
    {
        ...
        $sql = " REPLACE INTO invoices_archive SET customer_account =:customer_account, invoice_number =:invoice_number, invoice_date =:invoice_date, due_date =:due_date, date_created =:date_created,terms =:terms,sales_id = :sales_id,po_number = :po_number ";
    ...
    */
    ...
    {
        $db = DB::connection()->getPdo();
        $sql = "UPDATE invoices_archive SET terms =:terms WHERE invoice_id = :id";
