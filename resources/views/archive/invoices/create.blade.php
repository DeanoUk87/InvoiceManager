        ...
        <div class="card">
            <div class="card-header" style="">
                <nav class="nav  justify-content-between">
                    <a class="navbar-brand">@lang('main.invoices.create')</a>
            ...
            <div class="card-body">
                ...
                <form action="{{route('invoices.store')}}" method="post" id="hezecomform" name="hezecomform" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        
	                <div class="form-group">
                        <label class="control-label" for="sales_id">@lang('main.invoices.field.sales_id')</label>
	                     <input id="sales_id" name="sales_id" class="form-control styler" type="text" maxlength="11"  value="" />
	                </div>

	                <div class="form-group">
                        <label class="control-label" for="customer_account">@lang('main.invoices.field.customer_account')</label>
	                     <input id="customer_account" name="customer_account" class="form-control styler" type="text" maxlength="50"  value="" />
	                </div>

	                <div class="form-group">
                        <label class="control-label" for="invoice_number">@lang('main.invoices.field.invoice_number')</label>
	                     <input id="invoice_number" name="invoice_number" class="form-control styler" type="text" maxlength="50"  value="" />
	                </div>
	                ...
	                <div class="form-group">
                        <label class="control-label" for="due_date">@lang('main.invoices.field.due_date')</label>
	                     <input id="due_date" name="due_date" type="text" class="datepicker form-control styler" value="" />
	                </div>

	                <div class="form-group">
                        <label class="control-label" for="date_created">@lang('main.invoices.field.date_created')</label>
	                     <input id="date_created" name="date_created" type="text" class="datepicker form-control styler" value="" />
	                </div>
                        ...
                        <div class="col-sm-12">
                           <div class="card">
                              ...
                              <div class="card-block editor-fit">
                                <textarea class="editor1" name="terms" ></textarea>
                              </div>
                           </div>
                        </div>
                     </div>
	                <div class="form-group">
                        <label class="control-label" for="printer">@lang('main.invoices.field.printer')</label>
	                     <input id="printer" name="printer" class="form-control styler" type="text" maxlength="5"  value="" />
	                </div>
	                ...
	                <div class="form-group">
                        <label class="control-label" for="num">@lang('main.invoices.field.num')</label>
	                     <input id="num" name="num" class="form-control styler" type="text" maxlength="50"  value="" />
	                </div>
