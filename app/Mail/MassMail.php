...
{
    use Queueable, SerializesModels, CustomQuery;
     ...
     * @return void
     */
    public function __construct($customer_account,$invoice_number,$invoice_date,$customer_email,$customer_email_bcc=null)
    {
