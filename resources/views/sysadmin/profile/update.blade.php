                        ...
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <div class="form-group">
                                    <input id="email" type="text" class="form-control p_input" name="email" value="{{ $user->email }}" readonly="readonly">
                                </div>
                                <div class="form-group">
                                    <input id="email" type="text" class="form-control p_input" name="username" value="{{ $user->username }}" readonly="readonly">
                                </div>
                                ...
                                {{--<div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                    <label for="phone" class="control-label">@lang('app.users.fields.name')</label>
                            ...
                            <div class="col-md-3">
                                <div class="col-md-10 col-md-offset-1">
                                    @if($user->avatar)
                                        <img src="{{ asset('public/uploads/avatars')}}/{{ $user->avatar }}" style="width:120px; float:left; border-radius:50%; margin-right:25px;">
                                    @else
                                        <img src="{{ asset('public/templates/admin/images/avatar.jpg')}}" style="width:120px; float:left; border-radius:50%; margin-right:25px;">
                                    @endif
