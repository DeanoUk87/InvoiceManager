                ...
                <div class="card-header">
                    <nav class="nav  justify-content-between">
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{route('archive-invoices.pdfdetails',['account'=>$customer_account,'invno'=>$invoice_number,'date'=>$invoice_date])}}" class="btn btn-success btn-sm" ><i class="fa fa-file-pdf-o"></i> @lang('app.pdf')</a>
                            ...
                            <a href="{{route('archive-invoices.pdfdetails',['account'=>$customer_account,'invno'=>$invoice_number,'date'=>$invoice_date,'print'=>1])}}" class="btn btn-warning btn-sm" target="_blank"><i class="fa fa-print"></i> Print</a>
                            @if(Auth::user()->hasAnyRole(['admin','admin2']))
                                <a href="#" title="Email" class="btn btn-default btn-sm" data-toggle="modal" data-target="#myModal"><i class="fa fa-envelope"></i> Email</a>
                            @endif
                        </div>
                    </nav>
                </div>
